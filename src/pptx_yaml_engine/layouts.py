...
LAYOUT_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "three_cards_vertical": ("3col_vertical", "3col_cards_vertical", "three_cards_vertical", "yaml__three_cards_vertical"),
    "three_cards_horizontal": ("3col_horizontal", "3col_cards_horizontal", "three_cards_horizontal", "yaml__three_cards_horizontal"),
    "timeline": ("timeline", "roadmap", "yaml__timeline"),
    "closing_end": ("closing", "end", "thank_you", "closing_end", "yaml__closing_end"),
    "kpi_big_number": ("kpi", "big_number", "kpi_big_number", "yaml__kpi_big_number"),
    "chart_basic": ("chart", "chart_basic", "yaml__chart_basic"),
    "image_caption": ("image_caption", "picture_caption", "icon_caption", "yaml__image_caption"),
    "appendix_backup": ("appendix", "backup", "appendix_backup", "yaml__appendix_backup"),
    "eol_notice": ("eol", "end_of_life", "eol_notice", "yaml__eol_notice"),
}
